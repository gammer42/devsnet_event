        ...
        <div class="testimonials_slider owl-carousel">
            <div class="item">
                <div class="testi_item">
                    ...
                    <div class="media">
                        <div class="d-flex">
                            <img class="rounded-circle" src="{{URL::to('ux_interface/img/testimonials/testi-1.jpg')}}" alt="">
                        </div>
            ...
            <div class="item">
                <div class="testi_item">
                    ...
                    <div class="media">
                        <div class="d-flex">
                            <img class="rounded-circle" src="{{URL::to('ux_interface/img/testimonials/testi-2.jpg')}}" alt="">
                        </div>
                        <div class="media-body">
                            <h4>Chriss Turner</h4>
                            <h5>CEO Enterprise</h5>
            ...
            <div class="item">
                <div class="testi_item">
                    ...
                    <div class="media">
                        <div class="d-flex">
                            <img class="rounded-circle" src="{{URL::to('ux_interface/img/testimonials/testi-3.jpg')}}" alt="">
                        </div>
                        <div class="media-body">
                            <h4>Julie Smart</h4>
                            <h5>CEO Enterprise</h5>
