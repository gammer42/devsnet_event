        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="team_people_text">
                    <div class="l_title">
                        <img src="{{URL::to('ux_interface/img/icon/title-icon.png')}}" alt="">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-6">
                            <div class="team_img_item">
                                <img src="{{URL::to('ux_interface/img/team/people/people-1.jpg')}}" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-6">
                            <div class="team_img_item">
                                <img src="{{URL::to('ux_interface/img/team/people/people-2.jpg')}}" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-6">
                            <div class="team_img_item">
                                <img src="{{URL::to('ux_interface/img/team/people/people-3.jpg')}}" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-6">
                            <div class="team_img_item">
                                <img src="{{URL::to('ux_interface/img/team/people/people-4.jpg')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
